...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'saml_libertyfederation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentic2.User']))

        # Changing field 'LibertyIdentityDump.user'
        db.alter_column(u'saml_libertyidentitydump', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authentic2.User'], unique=True))

    def backwards(self, orm):

        # Changing field 'LibertyFederation.user'
        db.alter_column(u'saml_libertyfederation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'LibertyIdentityDump.user'
        db.alter_column(u'saml_libertyidentitydump', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
