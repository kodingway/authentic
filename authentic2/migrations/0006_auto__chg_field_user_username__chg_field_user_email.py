...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'authentic2_user', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256))

        # Changing field 'User.email'
        db.alter_column(u'authentic2_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'User.username'
        db.alter_column(u'authentic2_user', 'username', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))

        # Changing field 'User.email'
        db.alter_column(u'authentic2_user', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))
