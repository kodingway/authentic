...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserExternalId.updated'
        db.add_column(u'authentic2_userexternalid', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(1970, 1, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserExternalId.updated'
        db.delete_column(u'authentic2_userexternalid', 'updated')
